...
L["Tracking"] = "Tracking"
L["Weapon Enchanted"] = "Weapon Enchanted"
L["Weapon"] = "Weapon"
...
L.sounds = {
  [" custom"] = "Custom",
  [WeakAuras.PowerAurasSoundPath.."aggro.wav"] = "Aggro",
  [WeakAuras.PowerAurasSoundPath.."Arrow_swoosh.wav"] = "Arrow Swoosh",
  [WeakAuras.PowerAurasSoundPath.."bam.wav"] = "Bam",
  [WeakAuras.PowerAurasSoundPath.."bear_polar.wav"] = "Polar Bear",
  [WeakAuras.PowerAurasSoundPath.."bigkiss.wav"] = "Big Kiss",
  [WeakAuras.PowerAurasSoundPath.."BITE.wav"] = "Bite",
  [WeakAuras.PowerAurasSoundPath.."brainfreeze.mp3"] = "Brain Freeze",
  [WeakAuras.PowerAurasSoundPath.."burp4.wav"] = "Burp",
  [WeakAuras.PowerAurasSoundPath.."cat2.mp3"] = "Cat",
  [WeakAuras.PowerAurasSoundPath.."chant2.wav"] = "Chant Major 2nd",
  [WeakAuras.PowerAurasSoundPath.."chant4.wav"] = "Chant Minor 3rd",
  [WeakAuras.PowerAurasSoundPath.."chimes.wav"] = "Chimes",
  [WeakAuras.PowerAurasSoundPath.."cookie.mp3"] = "Cookie Monster",
  [WeakAuras.PowerAurasSoundPath.."ESPARK1.wav"] = "Electrical Spark",
  [WeakAuras.PowerAurasSoundPath.."fingeroffrost.mp3"] = "Finger of Frost",
  [WeakAuras.PowerAurasSoundPath.."Fireball.wav"] = "Fireball",
  [WeakAuras.PowerAurasSoundPath.."Gasp.wav"] = "Gasp",
  [WeakAuras.PowerAurasSoundPath.."heartbeat.wav"] = "Heartbeat",
  [WeakAuras.PowerAurasSoundPath.."hic3.wav"] = "Hiccup",
  [WeakAuras.PowerAurasSoundPath.."hotstreak.mp3"] = "Hot Streak",
  [WeakAuras.PowerAurasSoundPath.."huh_1.wav"] = "Huh?",
  [WeakAuras.PowerAurasSoundPath.."hurricane.wav"] = "Hurricane",
  [WeakAuras.PowerAurasSoundPath.."hyena.wav"] = "Hyena",
  [WeakAuras.PowerAurasSoundPath.."kaching.wav"] = "Kaching",
  [WeakAuras.PowerAurasSoundPath.."missilebarrage.mp3"] = "Missile Barrage",
  [WeakAuras.PowerAurasSoundPath.."moan.mp3"] = "Moan",
  [WeakAuras.PowerAurasSoundPath.."panther1.wav"] = "Panther",
  [WeakAuras.PowerAurasSoundPath.."phone.mp3"] = "Phone",
  [WeakAuras.PowerAurasSoundPath.."PUNCH.wav"] = "Punch",
  [WeakAuras.PowerAurasSoundPath.."rainroof.wav"] = "Rain",
  [WeakAuras.PowerAurasSoundPath.."rocket.wav"] = "Rocket",
  [WeakAuras.PowerAurasSoundPath.."shipswhistle.wav"] = "Ship's Whistle",
  [WeakAuras.PowerAurasSoundPath.."shot.mp3"] = "Gunshot",
  [WeakAuras.PowerAurasSoundPath.."snakeatt.wav"] = "Snake Attack",
  [WeakAuras.PowerAurasSoundPath.."sneeze.wav"] = "Sneeze",
  [WeakAuras.PowerAurasSoundPath.."sonar.mp3"] = "Sonar",
  [WeakAuras.PowerAurasSoundPath.."splash.mp3"] = "Splash",
  [WeakAuras.PowerAurasSoundPath.."Squeakypig.wav"] = "Squeaky Toy",
  [WeakAuras.PowerAurasSoundPath.."swordecho.wav"] = "Sword Ring",
  [WeakAuras.PowerAurasSoundPath.."throwknife.wav"] = "Throwing Knife",
  [WeakAuras.PowerAurasSoundPath.."thunder.wav"] = "Thunder",
  [WeakAuras.PowerAurasSoundPath.."wickedmalelaugh1.wav"] = "Wicked Male Laugh",
  [WeakAuras.PowerAurasSoundPath.."wilhelm.mp3"] = "Wilhelm Scream",
  [WeakAuras.PowerAurasSoundPath.."wlaugh.wav"] = "Wicked Female Laugh",
  [WeakAuras.PowerAurasSoundPath.."wolf5.wav"] = "Wolf Howl",
  [WeakAuras.PowerAurasSoundPath.."yeehaw.wav"] = "Yeehaw"
}
