...
if(WeakAuras.PowerAurasSoundPath ~= "") then
  ...
  WeakAuras.sound_types[WeakAuras.PowerAurasSoundPath.."brainfreeze.ogg"] = "Brain Freeze";
  ...
  WeakAuras.sound_types[WeakAuras.PowerAurasSoundPath.."fingeroffrost.ogg"] = "Finger of Frost";
  ...
  WeakAuras.sound_types[WeakAuras.PowerAurasSoundPath.."hotstreak.ogg"] = "Hot Streak";
  ...
  WeakAuras.sound_types[WeakAuras.PowerAurasSoundPath.."missilebarrage.ogg"] = "Missile Barrage";
