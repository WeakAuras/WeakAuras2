...
-- luacheck: globals POWER_TYPE_MANA POWER_TYPE_RED_POWER POWER_TYPE_FOCUS POWER_TYPE_ENERGY POWER_TYPE_COMBO_POINTS POWER_TYPE_RUNIC_POWER POWER_TYPE_SOUL_SHARDS POWER_TYPE_LUNAR_POWER POWER_TYPE_HOLY_POWER POWER_TYPE_MAELSTROM POWER_TYPE_CHI POWER_TYPE_INSANITY POWER_TYPE_ARCANE_CHARGES POWER_TYPE_FURY POWER_TYPE_PAIN
...
WeakAuras.power_types = {
  ...
  [2] = POWER_TYPE_FOCUS,
  [3] = POWER_TYPE_ENERGY,
  [4] = POWER_TYPE_COMBO_POINTS,
  [6] = POWER_TYPE_RUNIC_POWER,
  [7] = POWER_TYPE_SOUL_SHARDS,
  [8] = POWER_TYPE_LUNAR_POWER,
  [9] = POWER_TYPE_HOLY_POWER,
