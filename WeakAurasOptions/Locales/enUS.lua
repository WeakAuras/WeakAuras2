...
L["Custom Progress Scale"] = "Custom Progress Scale"
...
L["Progress Scale"] = "Progress Scale"
L["Progress above this value will show as full progress (no progress for an inversed display)."] = "Progress above this value will show as full progress (no progress for an inversed display)."
...
L["The cooldown animation will begin when less than this duration remains."] = "The cooldown animation will begin when less than this duration remains."
...
L["Use this for displays that have the same size and for which progress should move at the same speed but their triggers report different durations."] = "Use this for displays that have the same size and for which progress should move at the same speed but their triggers report different durations."
