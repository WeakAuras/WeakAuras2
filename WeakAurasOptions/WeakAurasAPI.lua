...
local WeakAurasAPI =
{
 ...
 Functions =
 {
  ...
  },
  {
   ...
   {
    { Name = "id", Type = "string", Nilable = false },
    { Name = "ignoreSpellKnown", Type = "bool", Nilable = true },
    { Name = "followoverride", Type = "bool", Nilable = true },
   },
  ...
  {
   Name = "UnitNameWithRealmCustomName",
   Type = "Function",
