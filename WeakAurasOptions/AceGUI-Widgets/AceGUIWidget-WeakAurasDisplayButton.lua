  ...
  ["Initialize"] = function(self)
    ...
    function self.callbacks.OnClickGrouping()
      ...
      for index, selectedId in ipairs(self.grouping) do
        ...
        tinsert(data.controlledChildren, selectedId);
        local selectedButton = WeakAuras.GetDisplayButton(selectedId);
        while selectedData.parent do
          selectedButton:Ungroup();
        end
        selectedButton:SetGroup(data.id, data.regionType == "dynamicgroup");
        selectedButton:SetGroupOrder(#data.controlledChildren, #data.controlledChildren);
        selectedData.parent = data.id;
    ...
    function self.callbacks.OnGroupClick()
      OptionsPrivate.StartGrouping(data);
    end
    ...
    function self.callbacks.OnDuplicateClick()
      ...
      if data.controlledChildren then
        local newGroup = OptionsPrivate.DuplicateAura(data)
