...
local methods = {
  ...
  ["Initialize"] = function(self)
      ...
      if self.data.parent then
        ...
        if index then
          if index <= 1 then
            ...
            OptionsPrivate.Private.Animate("button", WeakAuras.GetData(parentData.controlledChildren[index - 1]).uid, "main", updata, self.frame, true, function()
              OptionsPrivate.SortDisplayButtons()
            end)
            OptionsPrivate.Private.Animate("button", WeakAuras.GetData(parentData.controlledChildren[index]).uid, "main", downdata, otherbutton.frame, true, function()
              OptionsPrivate.SortDisplayButtons()
            end)
            WeakAuras.FillOptions()
          end
      ...
      if self.data.parent then
        ...
        if index then
          if index >= #parentData.controlledChildren then
            ...
            local updata = { duration = 0.15, type = "custom", use_translate = true, x = 0, y = -32 }
            local downdata = { duration = 0.15, type = "custom", use_translate = true, x = 0, y = 32 }
            OptionsPrivate.Private.Animate("button", WeakAuras.GetData(parentData.controlledChildren[index + 1]).uid, "main", downdata, self.frame, true, function()
              OptionsPrivate.SortDisplayButtons()
            end)
            OptionsPrivate.Private.Animate("button", WeakAuras.GetData(parentData.controlledChildren[index]).uid, "main", updata, otherbutton.frame, true, function()
              OptionsPrivate.SortDisplayButtons()
            end)
            WeakAuras.FillOptions()
          end
    ...
    tinsert(self.menu, {
      ...
      notCheckable = true,
      func = function()
        OptionsPrivate.ExportToString(self.data.id)
      end,
    })
    tinsert(self.menu, {
      ...
      notCheckable = true,
      func = function()
        OptionsPrivate.ExportToTable(self.data.id)
      end,
    })
...
local function Constructor()
  ...
  view:SetScript("OnEnter", function()
    Show_Tooltip(button, L["View"], L["Toggle the visibility of this display"])
  end)
  ...
  loaded:SetScript("OnEnter", function()
    Show_Tooltip(button, loaded.title, loaded.desc)
  end)
  ...
  group:SetScript("OnEnter", function()
    Show_Tooltip(button, L["Group (verb)"], L["Put this display in a group"])
  end)
  ...
  ungroup:SetScript("OnEnter", function()
    Show_Tooltip(button, L["Ungroup"], L["Remove this display from its group"])
  end)
  ...
  upgroup:SetScript("OnEnter", function()
    Show_Tooltip(button, L["Move Up"], L["Move this display up in its group's order"])
  end)
  ...
  expand:SetScript("OnEnter", function()
    Show_Tooltip(button, expand.title, expand.desc)
  end)
