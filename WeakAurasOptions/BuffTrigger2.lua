...
local function GetBuffTriggerOptions(data, triggernum)
  ...
  local function HasMatchPerUnitCount(trigger)
    if trigger.type == "aura2" and IsGroupTrigger(trigger) and trigger.showClones and trigger.combinePerUnit and trigger.perUnitMode ~= "unaffected" then
  ...
  local aura_options = {
    ...
    use_stealable = {
      ...
      name = function(input)
        ...
        elseif value == false then
          return "|cFFFF0000 " .. L["Negator"] .. " " .. L["Is Stealable"] .. "|r"
        else
          return "|cFF00FF00" .. L["Is Stealable"] .. "|r"
        end
      end,
      width = WeakAuras.doubleWidth,
      order = 64,
    ...
    use_isBossDebuff = {
      ...
      name = function(input)
        ...
        elseif value == false then
          return "|cFFFF0000 " .. L["Negator"] .. " " .. L["Is Boss Debuff"] .. "|r"
        else
          return "|cFF00FF00" .. L["Is Boss Debuff"] .. "|r"
        end
      end,
      width = WeakAuras.doubleWidth,
      order = 64.1,
    ...
    use_castByPlayer = {
      ...
      name = function()
        ...
        if value == nil then
          return L["Cast by a Player Character"]
        elseif value == false then
          return "|cFFFF0000 " .. L["Negator"] .. " " .. L["Cast by a Player Character"]
        else
          return "|cFF00FF00" .. L["Cast by a Player Character"]
        end
      end,
    ...
    ownOnly = {
      ...
      name = function()
        ...
        if value == nil then
          return L["Own Only"]
        elseif value == false then
          return "|cFFFF0000 " .. L["Negator"] .. " " .. L["Own Only"] .. "|r"
        else
          return "|cFF00FF00" .. L["Own Only"] .. "|r"
        end
      end,
      desc = function()
        local value = trigger.ownOnly
    ...
    fetchRole = {
      ...
      width = WeakAuras.doubleWidth,
      hidden = function()
        return not (trigger.type == "aura2" and trigger.unit ~= "multi") or WeakAuras.IsClassicOrBCCOrWrath()
      end,
    },
    fetchRaidMark = {
      type = "toggle",
    ...
    actualSpec = {
      ...
      hidden = function()
        return not (trigger.type == "aura2" and (trigger.unit == "group" or trigger.unit == "raid" or trigger.unit == "party") and trigger.useActualSpec and WeakAuras.IsRetail())
      end,
      order = 66.4,
    },
    actualSpecSpace = {
    ...
    npcId = {
      ...
      validate = ValidateNumeric,
      hidden = function()
        return not (trigger.type == "aura2" and trigger.unit == "nameplate" and trigger.useNpcId)
      end,
      order = 69.32,
    },
    npcIdSpace = {
      ...
      width = WeakAuras.normalWidth,
      hidden = function()
        return not (trigger.type == "aura2" and trigger.unit == "nameplate" and not trigger.useNpcId)
      end,
    },
    ...
    useMatchPerUnit_count = {
      ...
      hidden = function()
        return not (trigger.type == "aura2" and IsGroupTrigger(trigger) and trigger.showClones and trigger.combinePerUnit and trigger.perUnitMode ~= "unaffected")
      end,
      order = 71.6,
    },
    ...
    matchPerUnit_countOperator = {
      ...
      values = OptionsPrivate.Private.operator_types,
      hidden = function()
        return not (HasMatchPerUnitCount(trigger))
      end,
