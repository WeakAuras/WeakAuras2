...
local function createOptions(id, data)
  ...
  local options = {
    ...
    cooldown = {
      ...
      get = function()
        return OptionsPrivate.Private.CanHaveDuration(data) and data.cooldown
      end,
    },
    inverse = {
      type = "toggle",
      ...
      disabled = function()
        return not (OptionsPrivate.Private.CanHaveDuration(data) and data.cooldown)
      end,
      get = function()
        return data.inverse and OptionsPrivate.Private.CanHaveDuration(data) and data.cooldown
      end,
      hidden = function()
        return not data.cooldown
      end,
    },
    cooldownSwipe = {
      type = "toggle",
