...
local function createOptions(id, data)
  ...
  local options = {
    ...
    cooldown = {
      ...
      name = L["Enable Swipe"],
      order = 11.1,
      desc = 'Enable the \"Swipe\" radial overlay',
    ...
    inverse = {
      ...
      name = L["Inverse"],
      order = 11.2,
      desc = "Invert the direction of progress",
    ...
    cooldownTextDisabled = {
      ...
      order = 11.5,
      desc = 'A timer will automatically be displayed according to default Interface Settings (overridden by some addons).\nEnable this setting if you want this timer to be hidden, or when using a WeakAuras text to display the timer',
      disabled = function() return not OptionsPrivate.Private.CanHaveDuration(data); end,
      hidden = function() return not data.cooldown end,
    },
    endHeader = {
