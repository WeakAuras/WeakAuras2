...
local function GetCustomTriggerOptions(data, triggernum)
  ...
  local customOptions = {
    ...
    check = {
      ...
      hidden = function()
        return not (trigger.type == "custom" and (trigger.custom_type == "status" or trigger.custom_type == "stateupdate") and trigger.check ~= "update")
      end,
      get = function()
    ...
    events2 = {
      ...
      order = 9.1,
      hidden = function()
        return not (trigger.type == "custom" and trigger.custom_type == "event")
      end,
      get = function()
        return trigger.events
      end,
    ...
    custom_hide = {
      ...
      order = 12,
      hidden = function()
        return not (trigger.type == "custom" and trigger.custom_type == "event" and trigger.custom_hide ~= "custom")
      end,
      values = OptionsPrivate.Private.eventend_types,
      get = function()
        trigger.custom_hide = trigger.custom_hide or "timed"
        return trigger.custom_hide
      end,
      set = function(info, v)
    ...
    duration = {
      ...
      order = 13,
      hidden = function()
        return not (trigger.type == "custom" and trigger.custom_type == "event" and trigger.custom_hide ~= "custom" and not trigger.dynamicDuration)
      end,
      get = function()
...
local function GetGenericTriggerOptions(data, triggernum)
  ...
  local combatLogOptions = {
    subeventPrefix = {
      ...
      control = "WeakAurasSortedDropdown",
      hidden = function()
        return not (trigger.type == combatLogCategory and trigger.event == "Combat Log")
      end,
      get = function(info)
    ...
    subeventSuffix = {
      ...
      control = "WeakAurasSortedDropdown",
      hidden = function()
        return not (trigger.type == combatLogCategory and trigger.event == "Combat Log" and OptionsPrivate.Private.subevent_actual_prefix_types[trigger.subeventPrefix])
      end,
      get = function(info)
